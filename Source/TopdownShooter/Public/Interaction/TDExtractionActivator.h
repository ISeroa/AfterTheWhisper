...
#include "TDExtractionActivator.generated.h"
...
UCLASS()
class TOPDOWNSHOOTER_API ATDExtractionActivator : public AActor, public ITDInteractableInterface
{
	GENERATED_BODY()

public:
	ATDExtractionActivator();
...
protected:
	...
	UPROPERTY(EditInstanceOnly, BlueprintReadOnly, Category = "Extraction")
	ATDExtractionZone* TargetExtractionZone = nullptr;
};
